...
try {
  ...
  /** Browserconfig */
  router.get('/browserconfigs', controller.search('listBrowserConfigs'));
  ...
  /** Browserscripts */
  router.get('/browserscripts', controller.search('listBrowserScripts'));
  ...
  /** Crawljobs */
  router.get('/crawljobs', controller.search('listCrawlJobs'));
  ...
  /** Crawlconfig */
  router.get('/crawlconfigs', controller.search('listCrawlConfigs'));
  ...
  router.get('/crawlhostgroupconfigs', controller.search('listCrawlHostGroupConfigs'));
  ...
  /** Schedule */
  router.get('/schedules', controller.search('listCrawlScheduleConfigs'));
  ...
  /** Politenessconfig */
  router.get('/politenessconfigs', controller.search('listPolitenessConfigs'));
